...
\begin{itemize}
\item DockerHub
\item Volumes for sharing data with the containers
\item Building a Docker image with R
\end{itemize}
\item dockerfile \vspace{0.2cm}
\begin{itemize}
\item dockerfile for scripting the building of an Image
...
\include{exercise-docker-image-01}
...
\include{exercise-docker-image-02}
...
\include{dockerfile_best_practices}
